<!--
RICH COPY/PASTE VERSION

How to use:
- Open this file in a Markdown Preview that supports HTML/CSS.
- Copy from the rendered preview (not the raw text) into Word/Google Docs.

Note:
- Some renderers (e.g., GitHub) sanitize <style>. For best results, copy from Cursor/VS Code preview.
-->

<style>
  /* Scoped styling for Markdown previews that honor <style> */
  .rich-md {
  ...
  .rich-md h3 { font-size: 16px; margin-top: 16px; }
  .rich-md h4 { font-size: 14px; margin-top: 14px; }

  .rich-md a { color: #2563eb; text-decoration: none; }
  .rich-md a:hover { text-decoration: underline; }
...
<div class="rich-md">
  <div class="rich-hero">
    <div class="rich-hero-title">
      Milestone 1 Complete: Rootstock SSI Integration — Testnet Launch
      <span class="pill">COMPLETE</span>
    </div>
    <div class="meta-row">
      <div><b>Date:</b> January 17, 2026</div>
      <div><b>Grant:</b> [2510] Self Sovereign Identity (SSI) Sandbox Rootstock Integration</div>
      <div><b>Milestone:</b> Milestone 1 — Testnet Launch with Rootstock Integration</div>
    </div>
  </div>
