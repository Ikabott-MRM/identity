...
describe('DWNController', () => {
  ...
  describe('credentials', () => {
    it('should return error if holderDid is not provided', async () => {
      await expect(controller.credentials(undefined)).rejects.toThrow(
        ...
        result: [
          {
            ...
            verifiableCredential: {
              vcDataModel: {
                ...
                issuer:
                  'did:dht:ccjfxe14qowb9eb37yafbkji37ppz7rpyd5bxbryxd4i1b58o8bo',
    ...
    it('should handle exceptions correctly', async () => {
      ...
      expect(response).toBe(
        sendErrorResponse(RequestError.UNEXPECTED_ERROR, 500, 'Test error'),
      );
    });
  });
});
